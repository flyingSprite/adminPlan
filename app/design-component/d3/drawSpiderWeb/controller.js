define(['adminApp', 'd3'], function (adminApp, d3) {
  ...
  adminApp.controller('D3DrawSpiderWebController', function ($scope, breadcrumb){
    breadcrumb.title = 'D3';
    breadcrumb.subTitle = 'Draw Spider Web';
    var self = this;

    self.title = 'Draw Spider Web';
    self.markTemplate = 'marks/d3/drawSpiderWeb.md';
    self.info = '使用d3绘制一个虚拟的蜘蛛网';
